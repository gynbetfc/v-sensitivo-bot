# ==================================================================================
# SKINS DO TESLA 369 BOT v8.0.0
# ==================================================================================
# Este arquivo contém todas as skins disponíveis para o bot.
# Cada skin define as cores e efeitos visuais da interface.
...
# Cache de skins para otimização
_skin_cache = []
_skin_cache_tempo = 0
SKIN_CACHE_DURACAO = 300

def get_skins_cache():
    """Retorna a lista de skins do cache ou recarrega se expirou."""
    import time
...
def get_skin_by_id(skin_id):
    """Retorna uma skin específica pelo ID."""
    for skin in SKINS:
        if skin['id'] == skin_id:
            return skin
    return SKINS[0]  # Retorna a skin padrão se não encontrar

def get_skins_by_categoria(categoria):
    """Retorna todas as skins de uma determinada categoria."""
    return [skin for skin in SKINS if skin.get('categoria') == categoria]
