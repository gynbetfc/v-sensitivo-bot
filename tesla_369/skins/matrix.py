SKIN_MATRIX = {
    'id': 'skin_matrix', 'nome': '🧬 TESLA MATRIX', 'desc': 'Chuva de caracteres verdes',
    'preco_moedas': 12, 'categoria': 'lendaria',
    ...
    'css_extra': 'body{background:#000000!important}.header{border-color:#00ff00!important}.terminal{color:#00ff00!important;font-family:monospace!important}'
}